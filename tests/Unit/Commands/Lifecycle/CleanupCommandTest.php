...
use PhpHive\Cli\Console\Commands\Lifecycle\CleanupCommand;
 ...
 *
 * Tests for the CleanupCommand that performs deep cleaning of all
 * generated files including dependencies. Verifies destructive operation
 * handling, confirmation prompts, and comprehensive cleanup.
 */
final class CleanupCommandTest extends TestCase
{
     ...
     * and alias for user convenience.
     */
    public function test_command_has_correct_name_and_aliases(): void
    {
        $this->assertSame('clean:all', $this->command->getName());
        $this->assertContains('cleanup', $this->command->getAliases());
    }

    /**
     * Test that command has correct description.
     *
     * Verifies the command description indicates destructive nature.
     */
    public function test_command_has_correct_description(): void
    {
        $this->assertSame('Deep clean all generated files (destructive)', $this->command->getDescription());
    }
    ...
    {
        $this->assertInstanceOf(CleanupCommand::class, $this->command);
